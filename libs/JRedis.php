...
class JRedis
{
    ...
    public static function getInstance()
    {
        if (!(self::$_instance instanceof self)) {
            ...
            if (!extension_loaded('redis')) {
                throw new Exception("请确认已安装redis扩展");
            }
    ...
    public function open(
        ...
        return $this->redis->open($host, $port, $timeout, $reserved, $retryInterval, $readTimeout);
    }
     ...
     *
     * @return float|bool Returns the read timeout (which can be set using setOption and JRedis::OPT_READ_TIMEOUT)
     * or FALSE if we're not connected
     */
    ...
    public function pconnect(
        ...
        return $this->redis->pconnect($host, $port, $timeout, $persistentId, $retryInterval, $readTimeout);
    }
     ...
     * @return bool
     *
     * @deprecated use JRedis::pconnect()
     * @see        pconnect()
     */
    public function popen(
        ...
        return $this->redis->popen($host, $port, $timeout, $persistentId, $retryInterval, $readTimeout);
    }
     ...
     * @example
     * <pre>
     * $redis->setOption(JRedis::OPT_SERIALIZER, JRedis::SERIALIZER_NONE);        // don't serialize data
     * $redis->setOption(JRedis::OPT_SERIALIZER, JRedis::SERIALIZER_PHP);         // use built-in serialize/unserialize
     * $redis->setOption(JRedis::OPT_SERIALIZER, JRedis::SERIALIZER_IGBINARY);    // use igBinary serialize/unserialize
     * $redis->setOption(JRedis::OPT_SERIALIZER, JRedis::SERIALIZER_MSGPACK);     // Use msgpack serialize/unserialize
     * $redis->setOption(JRedis::OPT_SERIALIZER, JRedis::SERIALIZER_JSON);        // Use json serialize/unserialize
     *
     * $redis->setOption(JRedis::OPT_PREFIX, 'myAppName:');                      // use custom prefix on all keys
     *
     ...
     * $redis->setOption(JRedis::OPT_SCAN, JRedis::SCAN_NORETRY);
     * $redis->setOption(JRedis::OPT_SCAN, JRedis::SCAN_RETRY);
     * </pre>
     */
     ...
     * @example
     * // return option value
     * $redis->getOption(JRedis::OPT_SERIALIZER);
     */
     ...
     * $redis->setOption(JRedis::OPT_SERIALIZER, JRedis::SERIALIZER_JSON);
     *
     ...
     *
     * @param int $mode JRedis::MULTI|JRedis::PIPELINE
     *                  Defaults to JRedis::MULTI.
     *                  A JRedis::MULTI block of commands runs as a single transaction;
     *                  a JRedis::PIPELINE block is simply transmitted faster to the server, but without any guarantee of atomicity.
     ...
     * </pre>
     */
    public function multi($mode = JRedis::MULTI)
    {
     ...
     *                                                                                                        The callback will get four arguments ($redis,
     ...
     *
     * @param string       $key
     * @param int          $position JRedis::BEFORE | JRedis::AFTER
     * @param string       $pivot
     * @param string|mixed $value
     *
     ...
     * <pre>
     * $redis->del('key1');
     * $redis->lInsert('key1', JRedis::AFTER, 'A', 'X');     // 0
     *
     * $redis->lPush('key1', 'A');
     * $redis->lPush('key1', 'B');
     * $redis->lPush('key1', 'C');
     *
     * $redis->lInsert('key1', JRedis::BEFORE, 'C', 'X');    // 4
     * $redis->lRange('key1', 0, -1);                       // array('A', 'B', 'X', 'C')
     *
     * $redis->lInsert('key1', JRedis::AFTER, 'C', 'Y');     // 5
     * $redis->lRange('key1', 0, -1);                       // array('A', 'B', 'X', 'C', 'Y')
     *
     * $redis->lInsert('key1', JRedis::AFTER, 'W', 'value'); // -1
     * </pre>
     */
     ...
     * @see        sIsMember()
     * @link       https://redis.io/commands/sismember
     * @deprecated use JRedis::sIsMember()
     *
     * @param string       $key
     * @param string|mixed $value
     */
     ...
     * @see        sMembers()
     * @link       https://redis.io/commands/smembers
     * @deprecated use JRedis::sMembers()
     *
     * @param  string $key
     * @return array   An array of elements, the contents of the set
     */
     ...
     * - string: JRedis::REDIS_STRING
     * - set:   JRedis::REDIS_SET
     * - list:  JRedis::REDIS_LIST
     * - zset:  JRedis::REDIS_ZSET
     * - hash:  JRedis::REDIS_HASH
     * - other: JRedis::REDIS_NOT_FOUND
     *
    ...
    {
        return $this->redis->zDelete($key, $member1, ...$otherMembers);
    }
     ...
     * @deprecated use JRedis::zRemRangeByScore()
     *
     * @param string $key
     * @param float  $start
     * @param float  $end
     ...
     * @see        zRemRangeByRank()
     * @link       https://redis.io/commands/zremrangebyscore
     * @deprecated use JRedis::zRemRangeByRank()
     *
     * @param string $key
     * @param int    $start
     * @param int    $end
    ...
    /**
     * @see        zUnionStore
     * @deprecated use JRedis::zUnionStore()
     *
     * @param string     $Output
     * @param array      $ZSetKeys
    ...
    /**
     * @see        zInterStore
     * @deprecated use JRedis::zInterStore()
     *
     * @param $Output
     * @param $ZSetKeys
     * @param array|null $Weights
     ...
     * @example
     * <pre>
     * $redis->setOption(JRedis::OPT_PREFIX, 'my-prefix:');
     * $redis->_prefix('my-value'); // Will return 'my-prefix:my-value'
     * </pre>
     */
    public function _prefix($value)
    {
        return $this->redis->_prefix($value);
    }
     ...
     * @example
     * <pre>
     * $redis->setOption(JRedis::OPT_SERIALIZER, JRedis::SERIALIZER_PHP);
     ...
     * @example
     * <pre>
     * $redis->setOption(JRedis::OPT_SERIALIZER, JRedis::SERIALIZER_NONE);
     ...
     *
     * @return int Either JRedis::ATOMIC, JRedis::MULTI or JRedis::PIPELINE
     *
